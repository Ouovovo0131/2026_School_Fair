...
const stalls: Stall[] = [
  ...
  { id: 7, name: "B1 射擊挑戰", location: "南側花圃與舞台間", icon: "🎯", description: "限時射擊闖關，累積分數可兌換小禮。", highlight: "高手對決", category: 'game' },
  { id: 8, name: "B2 套圈圈樂園", location: "南側花圃與舞台間", icon: "⭕", description: "經典套圈圈遊戲，大小獎品等你帶回家。", highlight: "闖關必玩", category: 'game' },
  { id: 9, name: "B3 手作吊飾", location: "南側花圃與舞台間", icon: "🪡", description: "可自選顏色與字母，現場完成專屬吊飾。", highlight: "客製限定", category: 'craft' },
  { id: 10, name: "B4 明信片工坊", location: "南側花圃與舞台間", icon: "✉️", description: "手繪與拼貼明信片，幫你蓋上校慶紀念章。", highlight: "紀念收藏", category: 'craft' },

  { id: 11, name: "C1 幸運抽抽樂", location: "北側花圃與舞台間", icon: "🎁", description: "憑代幣抽獎，有機會抽中大型驚喜禮。", highlight: "大獎等你", category: 'game' },
  { id: 12, name: "C2 猜謎問答站", location: "北側花圃與舞台間", icon: "🧠", description: "校史、生活與趣味題，答對即可拿點數。", highlight: "腦力激盪", category: 'game' },
  { id: 13, name: "C3 香氛擴香石", location: "北側花圃與舞台間", icon: "🕯️", description: "挑選香味與模具，做出屬於自己的擴香石。", highlight: "療癒手作", category: 'craft' },
  { id: 14, name: "C4 彩繪扇子", location: "北側花圃與舞台間", icon: "🪭", description: "提供模板與顏料，完成獨一無二的彩繪扇。", highlight: "夏日必備", category: 'craft' },

  { id: 15, name: "D1 校刊紀念攤", location: "北側花圃與圖資大樓間", icon: "📚", description: "歷年校刊精選與限量紀念小冊免費翻閱。", highlight: "校史回顧", category: 'other' },
  { id: 16, name: "D2 二手好物市集", location: "北側花圃與圖資大樓間", icon: "♻️", description: "書籍、文具與小物交流，推廣循環再利用。", highlight: "環保愛地球", category: 'other' },
  { id: 17, name: "D3 公益義賣攤", location: "北側花圃第一列", icon: "❤️", description: "義賣所得捐助公益團體，歡迎一起做善事。", highlight: "愛心滿滿", category: 'other' },
  { id: 18, name: "D4 班級攝影棚", location: "北側花圃第一列", icon: "📸", description: "提供拍照道具與即時沖印，留下校慶回憶。", highlight: "限定合影", category: 'other' },
  { id: 19, name: "D5 樂團周邊店", location: "北側花圃第一列", icon: "🎸", description: "學生樂團貼紙、徽章與應援卡限量發售。", highlight: "粉絲必收", category: 'other' },
  { id: 20, name: "D6 社團招募站", location: "北側花圃第一列", icon: "📣", description: "各社團成果展示與入社資訊一次看齊。", highlight: "找到同好", category: 'other' },
  { id: 21, name: "D7 打卡任務區", location: "北側花圃第一列", icon: "🗺️", description: "完成地圖打卡任務可兌換校慶限定小禮。", highlight: "全場串聯", category: 'other' },
  { id: 22, name: "D8 休憩補給站", location: "北側花圃第一列", icon: "🧃", description: "提供飲水與短暫休息空間，補充體力再出發。", highlight: "能量補給", category: 'other' },

  { id: 23, name: "E1 經典雞蛋糕", location: "北側花圃第二列（信義樓旁）", icon: "🧇", description: "現烤雞蛋糕，原味與巧克力口味熱騰騰出爐。", highlight: "香甜現烤", category: 'food' },
  { id: 24, name: "E2 鐵板炒麵屋", location: "北側花圃第二列（信義樓旁）", icon: "🍜", description: "鐵板現炒麵食，提供加蛋與起司加料。", highlight: "熱炒人氣", category: 'food' },
  { id: 25, name: "E3 迷你籃球賽", location: "北側花圃第二列（信義樓旁）", icon: "🏀", description: "限時投籃挑戰，累計命中可兌換小禮品。", highlight: "手感爆發", category: 'game' },
  { id: 26, name: "E4 立體拼豆坊", location: "北側花圃第二列（信義樓旁）", icon: "🧩", description: "挑選模板製作拼豆作品，完成後可帶回收藏。", highlight: "創意滿點", category: 'craft' },
  { id: 27, name: "E5 文創貼紙舖", location: "北側花圃第二列（信義樓旁）", icon: "🧷", description: "原創貼紙與小卡販售，支持學生文創設計。", highlight: "限定設計", category: 'other' },
  { id: 28, name: "E6 終章集章站", location: "北側花圃第二列（信義樓旁）", icon: "🏁", description: "完成 E 區任務可蓋章，蒐集章點兌換紀念品。", highlight: "集章衝刺", category: 'other' },
];
