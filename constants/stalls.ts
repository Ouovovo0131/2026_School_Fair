...
export const STALL_DIRECTORY: Record<StallId, StallInfo> = {
  ...
  3:   { id: "3",   displayName: "好火火熱狗~好窩", category: "snack", content: "熱狗堡" },
  ...
  14:  { id: "14",  displayName: "50藍", category: "snack", content: "缺" },
  ...
  18:  { id: "18",  displayName: "不塑哥們", category: ["snack", "beverage", "game"], content: "香腸 & 檸檬茶、紅茶 & 包你發老虎機" },
